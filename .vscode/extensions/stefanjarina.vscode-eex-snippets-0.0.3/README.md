...
Please read the [CHANGELOG](https://github.com/stefanjarina/vscode-eex-snippets/blob/master/CHANGELOG.md) to see what has changed in this extension over time.
...
[MIT](https://github.com/stefanjarina/vscode-eex-snippets/blob/master/LICENSE.md) License
